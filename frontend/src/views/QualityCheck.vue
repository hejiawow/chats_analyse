<template>
  <div class="page-card quality-check-page">
    ...
    <!-- Detail modal -->
    <a-modal v-model:open="detailVisible" title="质检详情" width="700px">
    ...
    <!-- Batch errors modal -->
    <a-modal v-model:open="batchErrorsVisible" title="批量质检失败详情" width="600px">
      <a-table
...
import { getQualityCheckList, getQualityCheckDetail, triggerBatchQualityCheck, getBatchProgress, getBatchErrors, cancelBatchQualityCheck, triggerBatchQualityCheckByMessages } from '@/api/qualitycheck'
